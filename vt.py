...
def about():
    messagebox.showinfo('About','Developed by Aditi Singh!')


home=Tk()
home.geometry('600x400')
home.title('Online Voting System')
home['bg'] = '#8B0A50'
Label(home,text=' Voting',font='Helvetica 30 bold italic underline',bg='#8B0A50').grid(row=1,column=20)
Button(home,text='Create new Poll +',command=create).grid(row=5,column=20)
Button(home,text='My Polls',command=polls).grid(row=6,column=20)
Button(home,text='Poll Results',command=selpl).grid(row=7,column=20)
Button(home,text='About',command=about).grid(row=10,column=20)
home.mainloop()